...
class NoiseGenerator(object):
    psd_options = {'H1': [f'/data/p_dsi/ligo/ML_MDC_dataset/psds/H1/psd-{i}.hdf' for i in range(20)],
                   'L1': [f'/data/p_dsi/ligo/ML_MDC_dataset/psds/L1/psd-{i}.hdf' for i in range(20)]}
...
def get_noise(dataset, start_offset=0, duration=2592000, seed=0,
    ...
    if dataset in [1, 2, 3]:
        ...
        seglist = get_real_noise(path='/data/p_dsi/ligo/ML_MDC_dataset/real_noise_file.hdf',
