...
def main(args):
    ...
    elif args.method == 'frozen_encoder':
        models.append(('frozen_encoder', two_channel_ligo_binary_classifier(encoder)))
    elif args.method == 'lora':
        models.append(('lora', two_channel_ligo_binary_classifier(encoder)))
    elif args.method == 'LoRA':
        models.append(('LoRA', two_channel_ligo_binary_classifier(whisper_model_with_lora)))
#        models.append(('LoRA', TwoChannelLIGOBinaryClassifierCNN(whisper_model_with_lora)))
    ...
    for model_name, model in models:
        ...
        if args.load_model_path is None:
            ...
            model = load_models(args.load_model_path + "lora_weights_2_2", args.load_model_path + "dense_layers_2_2.pth")
