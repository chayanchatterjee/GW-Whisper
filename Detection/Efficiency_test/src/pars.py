...
#train_signals = [0, 40000]
#valid_signals = [0, 40000]
#test_signals = [0, 40000]

#train_combined_noises = [0, 40000]
#valid_combined_noises = [0, 40000]
#test_combined_noises = [0, 40000]

#train_pure_noises = [40000, 80000]
#valid_pure_noises = [40000, 80000]
#test_pure_noises = [0, 160000]
