...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default='Detection/data/Whisper_train_mass-8to100_resampled_train', help='Path to the dataset')
    parser.add_argument('--models-path', type=str, default='Detection/results/Two_detectors/models', help='Path to save the model weights')
    parser.add_argument('--figures-path', type=str, default='Detection/results/Two_detectors/figures', help='Path to save the figures')
    parser.add_argument('--log-dir', type=str, default='Detection/results/Two_detectors/logs', help='Directory to save the TensorBoard logs')
